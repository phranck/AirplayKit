...
**What was done.** Emma, a HomePod mini, read four times through `GET /info` and through its Bonjour record at the same moments: at rest, whilst an iPhone played to it alone, after the playback was stopped, and after the iPhone disconnected from it.
