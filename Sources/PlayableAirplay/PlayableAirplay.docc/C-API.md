...
Use the `CPlayableAirplay` product and include `PlayableAirplay.h`. The header defines the signatures, ownership rules and parameter contracts. This page lists every public C entry point and the objects they use.
