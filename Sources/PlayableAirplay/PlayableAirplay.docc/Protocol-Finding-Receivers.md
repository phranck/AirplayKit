...
|---|---|---|---|---|
| Room A | member | Sonos Arc | S19 | `Arc` |
| Room A | satellite | Sonos One | S18 | not advertised |
| Room A | satellite | Sonos One | S13 | not advertised |
| Room B | member | Sonos One | S18 | `One` |
| Room B | invisible | Sonos One SL | S22 | not advertised |
| Room C | member | Sonos One | S18 | `One` |
| Room D | member | SYMFONISK Bookshelf | S33 | `Bookshelf` |
| Room E | member | SYMFONISK Bookshelf | S33 | `Bookshelf` |
